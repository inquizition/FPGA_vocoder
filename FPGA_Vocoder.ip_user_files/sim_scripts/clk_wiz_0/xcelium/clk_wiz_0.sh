...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../ipstatic" +incdir+"../../../../../i2s_playback/i2s_playback.gen/sources_1/ip/clk_wiz_0" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../ipstatic" +incdir+"../../../../../i2s_playback/i2s_playback.gen/sources_1/ip/clk_wiz_0" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/linus/FPGA_Vocoder/FPGA_Vocoder.cache/compile_simlib/xcelium"
  fi
