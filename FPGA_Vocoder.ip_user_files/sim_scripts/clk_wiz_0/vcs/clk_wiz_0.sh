...
#
# Script generated by Vivado on Sat Nov 25 21:58:25 CET 2023
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../ipstatic" +incdir+"../../../../../i2s_playback/i2s_playback.gen/sources_1/ip/clk_wiz_0" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../ipstatic" +incdir+"../../../../../i2s_playback/i2s_playback.gen/sources_1/ip/clk_wiz_0" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/linus/FPGA_Vocoder/FPGA_Vocoder.cache/compile_simlib/vcs"
  fi
